...
public class DrawScriptGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "SPACE", "COMMENT_BLOCK", 
			"COMMENT_LINE", "ASSIGN", "BOOL", "NUM", "COMPARATOR", "OPERATOR", "NEWLINE", 
			"CONST", "ID"
		};
	}
	...
	public DrawScriptGrammarLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "DrawScriptGrammar.g4"; }
